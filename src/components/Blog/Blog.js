        ...
        <div>
            ...
            <div className='blog'>
                ...
                <div className='blog-ques'>
                    ...
                    <p><strong>Answer: </strong>Firebase helps you develop high-quality apps, grow your user base, and earn more money. Each feature works independently, and they work even better together. Firebase is easy to manage</p>
                </div>
                <div className='blog-ques'>
